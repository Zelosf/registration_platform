# Generated by Django 5.0.7 on 2024-08-08 16:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_create_program', 'Can Create Program'), ('can_edit_program', 'Can Edit Program')],
            },
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('electronic_ticket', models.CharField(max_length=255)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.event')),
